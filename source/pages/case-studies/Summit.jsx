    ...
    return (
      <CaseStudy introProps={this.props}>
        <section>
          ...
          <p>
            Every year, <Link href="http://thoughtbot.com" target="_new">thoughtbot</Link> assembles the entire team from all of its offices to celebrate the year and get to know the other people you may not have seen in person yet.
          ...
          <p>
            Since we had both iPhone and Android users, I suggested we use <Link href="http://ionic.io" target="_new">Ionic</Link> so we could support them both.
        ...
        <section>
          ...
          <p>
            ...
            We had no official time to spend on the project, so after <Link href="https://robots.thoughtbot.com/design-spiking" target="_new">a very short Design Sprint</Link>, we decided to work with just myself and another designer.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            &nbsp;<Link href="http://summit-guide-2015.herokuapp.com" target="_new">Check it out in your browser</Link> to get an idea for your next visit to Denver.
          </p>
        </section>
      </CaseStudy>
    );
...
SummitCaseStudy.defaultProps = {
  ...
  summary: "I worked together with other thoughtbot Denver designers to design and build a mobile app to help our friends get around town for our annual company summit. I was the sole developer, and using <a href='https://ionic.io' target='_new' rel='noopener'>Ionic</a> made it possible to build quickly and work on everyone's devices."
}
